/**
 * gemini.js — AI Message Generator for Arcade Studio
 * Calls POST /generate-ai on the Cloudflare Worker.
 * API Key TIDAK pernah menyentuh browser — tersimpan di Cloudflare Secrets.
 *
 * Disesuaikan untuk Arcade Edition:
 * - Target textarea: #input-message (bukan #polaroid-letter-input)
 */
...
const GeminiAI = (() => {
  ...
  function applyResult() {
    ...
    // Target: textarea utama di Arcade Studio (section "Tulis Pesan")
