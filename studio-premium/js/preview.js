...
const Preview = (() => {
  ...
  async function openPreview() {
    ...
    // Proteksi Premium: Minimal ada 1 foto
    ...
    Studio.showToast('Menyimpan perubahan & Membuka Preview VIP...');
    
    try {
      // Autosave secara paksa sebelum mengarahkan window
  ...
  async function openSectionPreview(room) {
    ...
    Studio.showToast(`Menyimpan & Membuka ${room.toUpperCase()} VIP...`);
